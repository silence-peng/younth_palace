...
public class QRCodeUtil {
     ...
     */
    public static boolean zxingCodeCreate(String content,  Integer size, String logoPath,String fileName) {
        try {
            String path=FileUtils.getUploadPath(2)+File.separator;
            //图片类型
    ...
    public static void main(String[] args) {
        QRCodeUtil.zxingCodeCreate("康儿推荐金瓶梅：https://www.qiuxia222.com/vod-play-id-1419-src-1-num-1.html，大家不要客气哈", "D:/",500,"D:/0834.jpg");
    }
